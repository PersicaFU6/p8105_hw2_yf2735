...
```
It's surprising that in series 5, although Nancy only became the STAR BAKER once but still won the competition.In series 6redictable overall winners? Any surprises?
## viewership 
